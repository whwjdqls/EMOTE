...
# video emotion loss
sys.path.append('../')
from models.video_emotion import VideoEmotionClassifier, 
...
def create_video_emotion_loss(cfg):
    ...
    class_ = class_from_str(model_config.model.pl_module_class, sys.modules[__name__]) # VideoEmotionClassifier
